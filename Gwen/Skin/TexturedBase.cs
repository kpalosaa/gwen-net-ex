...
namespace Gwen.Skin
{
    ...
    public struct SkinTextures
    {
		...
		public Bordered ToolWindow;
		public Bordered ToolWindowVertical;
    ...
    public class TexturedBase : Skin.Base
    {
        ...
        private void InitializeTextures()
        {
			...
			Textures.ToolWindow = new Bordered(m_Texture, 384, 464, 127, 31, new Margin(18, 8, 8, 8));
			Textures.ToolWindowVertical = new Bordered(m_Texture, 256, 384, 31, 127, new Margin(8, 18, 8, 8));
        ...
        public override void DrawTabButton(Control.Base control, bool active, Dock dir)
        {
            if (active)
            {
        ...
        private void DrawActiveTabButton(Control.Base control, Dock dir)
        {
            if (dir == Dock.Top)
            {
		...
		public override void DrawToolWindow(Control.Base control, bool vertical)
		{
			if (vertical)
				Textures.ToolWindowVertical.Draw(Renderer, control.RenderBounds);
			else
				Textures.ToolWindow.Draw(Renderer, control.RenderBounds);
		}
        ...
        public override void DrawScrollButton(Control.Base control, Control.Internal.ScrollBarButtonDirection direction, bool depressed, bool hovered, bool disabled)
        {
            int i = 0;
        ...
        public override void DrawTreeNode(Control.Base ctrl, bool open, bool selected, int labelHeight, int labelWidth, int halfWay, int lastBranch, bool isRoot)
        {
            if (selected)
            {
                Textures.Selection.Draw(Renderer, new Rectangle(15, 0, labelWidth, labelHeight));
            }
        ...
        public override void DrawModalControl(Control.Base control, Color? backgroundColor)
        {
		...
		public override void DrawBorder(Control.Base control, BorderType borderType)
		{
			switch (borderType)
			{
